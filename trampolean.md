...
Autre chantier, beaucoup d’institutions proposent des données publiques  qui sont pour l’instant sous-exploitées dans leurs applications logicielles. Nous pourrions utiliser gymkhana pour faciliter la concertation et l’implication des citoyens.

Gymkhana n'est pas qu'une succession d'ateliers ou de jeux, c'est une nouvelle approche pour faciliter l'innovation sociale et solidaire qui permet de casser la cloison entre les développeurs et les usagers.
